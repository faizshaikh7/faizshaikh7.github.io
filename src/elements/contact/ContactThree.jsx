            ...
            <div className="col-lg-6 order-2 order-lg-1">
              <div className="section-title text-left mb--50">
                ...
                <p className="description">
                  ...
                  <a href="tel:+919653179521">+91 96531 79521</a> or email:
                  <a href="mailto:faizshaikh.dev@gmail.com">
                    {" "}
                    faizshaikh.dev@gmail.com
                  </a>{" "}
                </p>
              </div>
              <div className="form-wrapper">
                <form>
                  ...
                  <button
                    ...
                    // onClick={sendExampleEmailRequest}
                  >
                    Submit
                  </button>
                </form>
